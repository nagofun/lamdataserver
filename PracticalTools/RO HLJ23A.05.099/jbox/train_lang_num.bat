...
tesseract.exe %1.font.exp%2.tif %1.font.exp%2 -l eng -psm 7 nobatch box.train 
 
echo Compute the Character Set.. 
unicharset_extractor.exe %1.font.exp0.box 
rem shapeclustering -F font_properties -U unicharet %1.font.exp%2.tr
mftraining -F font_properties -U unicharset -O %1.unicharset %1.font.exp%2.tr 
 
echo Clustering.. 
cntraining.exe %1.font.exp%2.tr 
...
echo Copy Tessdata...
copy /Y %1.traineddata D:\Program Files (x86)\Tesseract-OCR\tessdata
